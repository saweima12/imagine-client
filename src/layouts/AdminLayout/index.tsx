...
const layout = () => {
    ...
    const navMenuState = useSyncExternalStore(navMenuStateStore.subscribe, navMenuStateStore.getState)
    ...
    return (<div className={clsx("dark", "admin-wrapper", navMenuState && "menu-open")}> 
            <NavBar />
            <MenuMask />
            <NavMenu />
